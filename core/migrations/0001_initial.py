# Generated by Django 2.2.13 on 2021-03-31 19:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('S', 'Sedan'), ('H', 'Hatchback'), ('J', 'Jeep')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('E', 'Exrerior'), ('I', 'Interior'), ('R', 'Rim and Tyres')], max_length=2)),
                ('label', models.CharField(choices=[('S', 'Sale'), ('N', 'New'), ('F', 'Featured')], max_length=1)),
                ('slug', models.SlugField()),
                ('description', models.TextField()),
                ('image', models.ImageField(upload_to='')),
            ],
